...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/yashwanth-linux/Hospital-SIH/backend/prisma/generated/hospitalClient",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/yashwanth-linux/Hospital-SIH/backend/prisma/hospitalschema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchemaHash": "4534b7570c52807894b08a94f245ed674564354e97f15620dbbc024914f4c0f0",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/generated/hospitalClient",
    "generated/hospitalClient",
  ]
...
path.join(process.cwd(), "prisma/generated/hospitalClient/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/generated/hospitalClient/schema.prisma")
